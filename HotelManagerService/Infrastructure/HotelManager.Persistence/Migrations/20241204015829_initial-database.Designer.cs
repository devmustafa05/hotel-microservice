...
namespace HotelManager.Persistence.Migrations
{
    ...
    [Migration("20241204015829_initial-database")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelManager.Domain.Entities.City", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AddByUserId = 1,
                            CreatedDate = new DateTime(2024, 12, 4, 4, 58, 0, 0, DateTimeKind.Local),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Adana"
                        },
            ...
            modelBuilder.Entity("HotelManager.Domain.Entities.ContactLocationMapping", b =>
                {
                    b.HasOne("HotelManager.Domain.Entities.Hotel", "Hotel")
                        .WithMany("ContactLocationMappings")
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelManager.Domain.Entities.HotelLocationContact", null)
            ...
            modelBuilder.Entity("HotelManager.Domain.Entities.Hotel", b =>
                {
                    b.Navigation("ContactLocationMappings");
