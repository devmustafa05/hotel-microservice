        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HotelLocationContactId = table.Column<int>(type: "integer", nullable: false),
                    AddByUserId = table.Column<int>(type: "integer", nullable: false),
                    UpdatedByUserId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), true, false, "Adana", null, null },
                    { 2, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), true, false, "Adıyaman", null, null },
                    { 3, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), true, false, "Afyonkarahisar", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), "Havuzlu Villalı Suit Her Şey Dahil", true, false, 0m, "İstanbul Merkez Hacı Osman", 0m, "Antalya Suit Otel", null, null },
                    { 2, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), "Havuzlu Villalı Suit Her Şey Dahil", true, false, 0m, "İstanbul Merkez Hacı Osman", 0m, "İstanbul Suit Otel", null, null }
                });

            migrationBuilder.InsertData(
                table: "Districts",
                columns: new[] { "Id", "AddByUserId", "CityId", "CreatedDate", "IsActive", "IsDeleted", "Name", "UpdatedByUserId", "UpdatedDate" },
                values: new object[] { 1, 1, 2, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), true, false, "AdanaDistrict", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "905412045792", new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, 1, true, false, null, null },
                    { 2, 1, "mustafa_yener05@hotmail.com", new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 2, 2, true, false, null, null }
                });

            migrationBuilder.InsertData(
                table: "HotelLocationContacts",
                columns: new[] { "Id", "AddByUserId", "CreatedDate", "HotelId", "IsActive", "IsDeleted", "Latitude", "Longitude", "Name", "UpdatedByUserId", "UpdatedDate" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, 35m, 45m, null, null, null },
                    { 2, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, 36m, 48m, null, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Müdür", new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, "Mustafa", "Yener", null, null },
                    { 2, 1, "Müdür2", new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, "Mustafa2", "Yener2", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, 3542m, 5542m, "LocationName", null, null },
                    { 2, 1, 1, new DateTime(2024, 12, 2, 7, 16, 0, 0, DateTimeKind.Local), 1, true, false, 3542m, 5542m, "LocationName2", null, null }
                });
