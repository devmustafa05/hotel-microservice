...
namespace HotelManager.Application.Features.Hotels.Command.CreateHotel
{
    public class CreateHotelCommandHandler : IRequestHandler<CreateHotelCommandRequest, Unit>
    {
        ...
        {   
            mapper.Map<HotelOfficial , HotelOfficialDto>(new List<HotelOfficialDto>());
            mapper.Map<HotelContact, HotelContactsDto>(new List<HotelContactsDto>());
            mapper.Map<HotelLocationContact, HotelLocationContactDto>(new List<HotelLocationContactDto>());
